...
export default function CreatePatient() {
  ...
  return (
    <div className="container">
      ...
      <button className='btn-primary m-2 rounded' onClick={getDataById} type='submit' >Validez l'ID du dossier patient à rechercher</button>
      <input value={id} placeholder='ID' onChange={(e) => setId(e.target.value)} />
      <br />
       <button className='btn-primary m-2 rounded' onClick={getDataByName} type='submit' >Validez le Nom du dossier patient à recherchez</button> 
